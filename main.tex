...
\usepackage{geometry}
\geometry{xetex,twoside,landscape,left=2cm,right=2cm,asymmetric=true,marginparwidth={0cm},marginparsep={2mm}}
...
\begin{document}
% \begin{titlepage}
%   \thispagestyle{empty} %封面不显示页码和页眉页脚
%   \vspace*{10mm}
%   \noindent{\Huge 群书治要考译}
%   \vfill
%   \begin{flushright}
%     {\Large 魏{~~~}征{~}虞世南{~}褚遂良{~}等撰}
%   \end{flushright}
%   \par
%   \begin{flushright}
%     {\Large 吕效祖{~}赵保玉{~}张耀武{~}主编}
%   \end{flushright} 
% \end{titlepage}
\begin{titlepage}
...
\newgeometry{twoside,left=8cm,right=2cm,asymmetric=true,marginparwidth={6cm},marginparsep={2mm}}
